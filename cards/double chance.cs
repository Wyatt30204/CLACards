...
{
    public class DoubleChance : CustomCard
    {
        /*
        ...
        */
        ...
        {
            return "Get two of the same random <color=#ff00ffff>Rare</color> card";
        }
        ...
        public bool condition(CardInfo card, Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
        {
            ...
            return (card.rarity == CardInfo.Rarity.Rare) && !card.categories.Intersect(DoubleChance.noLotteryCategories).Any();
